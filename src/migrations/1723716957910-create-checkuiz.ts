...
export class CreateCheckuiz1723716957910 implements MigrationInterface {
  name = 'CreateCheckuiz1723716957910';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "profile_image_url" character varying, "is_checky" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE "workspace" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "folder_order" integer array NOT NULL DEFAULT \'{}\', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "permission_code" character varying NOT NULL, CONSTRAINT "PK_ca86b6f9b3be5fe26d307d09b49" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE "folder" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "checklist_order" integer array NOT NULL DEFAULT \'{}\', "is_default" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "permission_code" character varying NOT NULL, "workspace_id" integer, CONSTRAINT "PK_6278a41a706740c94c02e288df8" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'CREATE TABLE "checklist" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "item_order" integer array, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "permission_code" character varying NOT NULL, "folder_id" integer, CONSTRAINT "PK_e4b437f5107f2a9d5b744d4eb4c" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'CREATE TABLE "checklist_item" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "memo" character varying, "image_url" character varying, "is_checked" boolean NOT NULL DEFAULT false, "checked_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "permission_code" character varying NOT NULL, "checklist_id" integer, CONSTRAINT "PK_0c52d9590c766a9ae718e16cebf" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'CREATE TABLE "permission" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
